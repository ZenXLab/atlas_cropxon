...
const apiKeys: APIKey[] = [
  {
    ...
    key: "atls_prod_sk_xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1234",
  ...
  },
  {
    ...
    key: "atls_dev_sk_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxabcd",
  ...
  },
  {
    id: "3",
    name: "Webhook Secret",
    key: "atls_whsec_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxefgh",
...
const webhooks = [
  {
    id: "1",
    url: "https://api.yourcompany.com/webhooks/atlas",
  ...
  {
    id: "2",
    url: "https://slack.com/webhooks/atlas-notifications",
    events: ["attendance.marked", "leave.approved"],
    status: "active",
...
const TenantAPIKeys: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "expired":
        return <Badge className="bg-[#FFB020]/10 text-[#FFB020] border-[#FFB020]/20">Expired</Badge>;
      case "revoked":
        return <Badge className="bg-[#E23E57]/10 text-[#E23E57] border-[#E23E57]/20">Revoked</Badge>;
      default:
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#0F1E3A]">API Keys</h1>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Generate a new API key for accessing ATLAS programmatically.
              </DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreateKey} className="bg-[#005EEB] hover:bg-[#0047B3]">
                Create Key
              </Button>
            </DialogFooter>
          </DialogContent>
      ...
      <div className="bg-[#005EEB]/5 border border-[#005EEB]/20 rounded-xl p-4 flex items-start gap-3">
        <Shield className="w-5 h-5 text-[#005EEB] mt-0.5" />
        <div>
          <h4 className="text-sm font-medium text-[#0F1E3A]">Keep your API keys secure</h4>
          <p className="text-sm text-[#6B7280] mt-1">
            Never share your API keys in public repositories or client-side code. Use environment variables and rotate keys regularly.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-gray-100">
          <h3 className="text-sm font-semibold text-[#0F1E3A]">API Keys</h3>
        </div>
        <div className="divide-y divide-gray-100">
          {keys.map((apiKey) => (
            <div key={apiKey.id} className="p-4 hover:bg-[#F7F9FC]/50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <button
                        ...
                        className="p-1 text-[#6B7280] hover:text-[#005EEB] transition-colors"
                      >
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-gray-100 flex items-center justify-between">
          <h3 className="text-sm font-semibold text-[#0F1E3A]">Webhook Endpoints</h3>
        ...
        <div className="divide-y divide-gray-100">
          {webhooks.map((webhook) => (
            <div key={webhook.id} className="p-4 hover:bg-[#F7F9FC]/50 transition-colors">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-[#E23E57]">
                    <Trash2 className="w-4 h-4" />
                  </Button>
                </div>
              </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-white/80 text-sm">
              Learn how to integrate ATLAS with your applications
            </p>
          </div>
