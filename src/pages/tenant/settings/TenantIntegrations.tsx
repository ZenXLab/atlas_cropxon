...
const integrations: Integration[] = [
  {
    ...
    description: "Sync employees, calendar, and documents with Google Workspace",
  ...
  },
  {
    id: "razorpay",
    name: "Razorpay",
    description: "Process payroll payments and reimbursements",
    category: "Payments",
    icon: CreditCard,
    connected: true,
    status: "active",
  ...
  },
  {
    id: "tally",
    name: "Tally ERP",
    description: "Export payroll data to Tally for accounting",
    category: "Accounting",
    icon: Database,
    connected: false,
    status: "inactive"
  },
  {
    id: "freshteam",
    name: "Freshteam",
    description: "Import candidates and recruitment data",
    category: "HR",
    icon: Users,
    connected: false,
    status: "inactive"
...
const TenantIntegrations: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "error":
        return <Badge className="bg-[#E23E57]/10 text-[#E23E57] border-[#E23E57]/20">Error</Badge>;
      default:
        return <Badge className="bg-[#6B7280]/10 text-[#6B7280] border-[#6B7280]/20">Inactive</Badge>;
    }
  };
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#0F1E3A]">Integrations</h1>
          <p className="text-sm text-[#6B7280] mt-1">
            Connect third-party services to extend ATLAS capabilities
          </p>
        </div>
